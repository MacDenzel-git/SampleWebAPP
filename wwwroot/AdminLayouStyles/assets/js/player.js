var adonisPlayer = {},
    ...
    adonisPlayer.init = function(){
        ...
        $('.adonis-mute-control').click(function(){
            ...
            {
                volume = $("#"+adonisPlayerID).data("jPlayer").options.volume;
...
jQuery(document).ready(function ($) {
    ...
    $(document).ready(
        function () {
            $.ajax({
                url: "http://localhost:56823/Home/PrivacyGet",
                method: "GET",
                success: function (data) {
                    ...
                    {
                        var singleObject = {};
                        singleObj['type'] = 'adonisAllPlaylist';
                        singleObj['value'] = entry;
                        tracks.push(singleObj);
                    });
                    for (const key of data) {
                        tracks.push(key.title);
                 }


                    adonisAllPlaylists[0] = tracks;
                }, error: function (err) {
                    console.log(err);
                }
            })
...
adonisAllPlaylists[0]
    ...
    //        mp3:"../assets/mp3/Shyreen - Nara Cover (malawi-music.com).mp3",
